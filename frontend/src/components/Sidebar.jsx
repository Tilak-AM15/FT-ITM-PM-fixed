    ...
    >
      ...
      <div className="pm-sidebar__scroll">
        ...
        {navGroups.map((group) => {
          ...
          return (
            <div
              className="pm-sidebar__group"
              key={group.label}
            >

              {!collapsed && (
                <div className="pm-sidebar__label">
                  {group.label}
                </div>
              )}
              ...
              {allowed.map((item) => {
                ...
                return (
                  ...
                  >
                    <span className="pm-nav-item__icon">
                      <Icon />
                    </span>

                    {!collapsed && (
                      <span className="pm-nav-item__text">
                        {item.label}
                      </span>
                    )}
                  </NavLink>
